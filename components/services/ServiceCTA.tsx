    ...
    return (
        <section id="contacto" className="py-20 md:py-32 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-mystic-purple/10 via-mystic-gold/5 to-mystic-purple/10"
                    animate={{
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto">
                    <FadeIn>
                        <div className="mystic-card p-8 md:p-12 text-center">
                            <motion.div
                            ...
                            {/* Trust Elements */}
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-8 border-t border-mystic-purple-light/30">
                                {[
                                    { icon: '🔒', text: 'Confidencial' },
                                    { icon: '⚡', text: 'Respuesta Inmediata' },
                                    { icon: '💝', text: 'Primera Consulta Gratis' },
                                ].map((item) => (
                                    <motion.div
                                        key={item.text}
